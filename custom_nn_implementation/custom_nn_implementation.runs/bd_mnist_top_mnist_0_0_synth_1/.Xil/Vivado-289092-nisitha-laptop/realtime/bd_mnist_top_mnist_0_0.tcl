...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-289092-nisitha-laptop/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include /media/nisitha/My_Passport/MOODLE/Vivado_projects/cnn_character_recognition/custom_cnn_implementation/custom_nn_implementation/custom_nn_implementation/custom_nn_implementation.srcs/sources_1/new {
      ...
      rt::read_verilog -include /media/nisitha/My_Passport/MOODLE/Vivado_projects/cnn_character_recognition/custom_cnn_implementation/custom_nn_implementation/custom_nn_implementation/custom_nn_implementation.srcs/sources_1/new {
      ...
      rt::read_verilog -include /media/nisitha/My_Passport/MOODLE/Vivado_projects/cnn_character_recognition/custom_cnn_implementation/custom_nn_implementation/custom_nn_implementation/custom_nn_implementation.srcs/sources_1/new /media/nisitha/My_Passport/MOODLE/Vivado_projects/cnn_character_recognition/custom_cnn_implementation/custom_nn_implementation/custom_nn_implementation/custom_nn_implementation.gen/sources_1/bd/bd_mnist/ip/bd_mnist_top_mnist_0_0/synth/bd_mnist_top_mnist_0_0.v
      rt::read_vhdl -lib xpm /tools/Xilinx/Vivado/2023.2/data/ip/xpm/xpm_VCOMP.vhd
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top bd_mnist_top_mnist_0_0
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-289092-nisitha-laptop/"
